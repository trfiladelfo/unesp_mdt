...
//
// Solid blue means connected.
// off means not connected.
//
//*****************************************************************************
...
MouseMoveHandler(void)
{
    ...
    if(bSendIt || bButtonChange)
    {
        ...
        // positions. Overrides Motion Button action (currently not implemented).
        //
        ...
        ui32Retcode = USBDHIDMouseStateChange((void *)&g_sMouseDevice, i8DeltaX,
                                            i8DeltaY, ui8Buttons);
...
KeyboardMain(void)
{
    ...
    else
    {
        ...
        {
            //
            // Send the Keyboard Packet button preses
            //
