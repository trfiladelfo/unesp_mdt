...
extern uint_fast8_t RTI_ReadItemEx(uint8_t ui8ProfileID,
                                    uint8_t ui8ItemID,
                                    uint8_t ui8Length,
                                    uint8_t *pui8Value);
...
extern void RTI_SendDataReq(uint8_t ui8DestIndex,
                            uint8_t ui8ProfileID,
                            uint16_t ui16VendorID,
                            uint8_t ui8TXOptions, uint8_t ui8Length,
                            uint8_t *pui8Data);
