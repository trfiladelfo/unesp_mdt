//*****************************************************************************
//
// aes128_ecb_encrypt.c - Simple AES128 ECB encryption demo.
//
...
//! <h1>AES128 ECB Encryption Demo (aes128_ecb_encrypt)</h1>
//!
//! Simple demo showing an encryption operation using the AES128 module in
//! ECB mode.  A single block of data is encrypted.
//!
...
main(void)
{
    ...
    //
    FrameDraw(&sContext, "aes128-ecb-encrypt");
    ...
    //
    ConfigureUART();
    UARTprintf("Starting AES128 ECB encryption demo.\n");
    ...
    AES128ECBEncrypt(g_pui32AES128PlainText, pui32CipherText, g_pui32AES128Key,
                     64, false);
