//*****************************************************************************
//
// sha1_hash.c - Simple SHA1 hash demo.
//
...
//! <h1>SHA1 Hash Demo (sha1_hash)</h1>
//!
...
//! SHA module.  It is for demostration purposes only.
//
//*****************************************************************************
...
//*****************************************************************************
//
// Expected hash results.  These results have been separately verified using
// a Perl script.
//
//*****************************************************************************
...
tSHA1TestVector g_psSHA1TestVectors[] =
{
    ...
    {
        { 0x11e16f58, 0x04518339, 0x6e6bcaff, 0xdf48fb60, 0xed5ff029 },
        1000
    },
    {
