//*****************************************************************************
//
// aes128_ecb_decrypt.c - Simple AES128 ECB decryption demo.
//
...
//! <h1>AES128 ECB Decryption Demo (aes128_ecb_decrypt)</h1>
//!
//! Simple demo showing an decryption operation using the AES128 module in
//! ECB mode.  A single block of data is decrypted.
//!
...
main(void)
{
    ...
    //
    FrameDraw(&sContext, "aes128-ecb-decrypt");
    ...
    //
    ConfigureUART();
    UARTprintf("Starting AES128 ECB decryption demo.\n");
    ...
    AES128ECBDecrypt(g_pui32AES128CipherText, pui32PlainText, g_pui32AES128Key,
                     64, false);
    ...
    AES128ECBDecrypt(pui32PlainText, g_pui32AES128CipherText, g_pui32AES128Key,
                     64, true);
