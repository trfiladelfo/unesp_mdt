//*****************************************************************************
//
// aes128_gcm_decrypt.c - Simple AES128 GCM decryption demo.
//
...
//! <h1>AES128 GCM Decryption Demo (aes128_gcm_decrypt)</h1>
//!
...
//*****************************************************************************
bool
AES128GCMDecrypt(uint32_t *pui32Src, uint32_t *pui32Dst, uint32_t ui32Length,
...
//*****************************************************************************
//
// This example decrypts blocks ciphertext using AES128 in GCM mode.  It
...
main(void)
{
    ...
    //
    FrameDraw(&sContext, "aes128-gcm-decrypt");
        ...
        ui8Vector++)
    {
        ...
        else
        {
            ...
            //
            UARTprintf("Performing decryption without uDMA.\n");
            AES128GCMDecrypt(pui32CipherText, pui32PlainText, ui32DataLength,
