//*****************************************************************************
//
// aes128_ccm_encrypt.c - Simple AES128 CCM encryption demo.
//
...
//! <h1>AES128 CCM Encryption Demo (aes128_ccm_encrypt)</h1>
//!
//! Simple demo showing an encryption operation using the AES128 module in
//! CCM mode.  A set of test cases are encrypted.
//!
...
//*****************************************************************************
//
// Test cases from the NIST SP 800-38C document.
//
//*****************************************************************************
...
//*****************************************************************************
bool
AES128CCMEncrypt(uint32_t *pui32Key, uint32_t *pui32Src, uint32_t *pui32Dst,
