...
main(void)
{
    ...
    //
    FrameDraw(&g_sContext, "mpu-fault");
    ...
    GrStringDraw(&g_sContext, "Check flash write", -1, 10, 60, 0);
    ...
    if((g_ui32MPUFaultCount == 1) && (g_ui32FaultStatus == 0x82) &&
       (g_ui32MMAR == 0x100))
    {
        GrStringDraw(&g_sContext, " OK", -1, 210, 60, 0);
    }
    else
    {
        bFail = 1;
        GrStringDraw(&g_sContext, "NOK", -1, 210, 60, 0);
    }
    ...
    // the 32 KB region.
    //
    GrStringDraw(&g_sContext, "Check flash read", -1, 10, 85, 0);
    g_ui32MPUFaultCount = 0;
    ...
    if((g_ui32MPUFaultCount == 1) && (g_ui32FaultStatus == 0x82) &&
       (g_ui32MMAR == 0x7820))
    {
        GrStringDraw(&g_sContext, " OK", -1, 210, 85, 0);
    }
    else
    {
        bFail = 1;
        GrStringDraw(&g_sContext, "NOK", -1, 210, 85, 0);
    }
    ...
    // 64 KB region.
    //
    GrStringDraw(&g_sContext, "Check RAM read", -1, 10, 110, 0);
    g_ui32MPUFaultCount = 0;
    ...
    {
        GrStringDraw(&g_sContext, " OK", -1, 210, 110, 0);
    }
    else
    {
        bFail = 1;
        GrStringDraw(&g_sContext, "NOK", -1, 210, 110, 0);
    }
    ...
    // 64 KB region.
    //
    GrStringDraw(&g_sContext, "Check RAM write", -1, 10, 135, 0);
    g_ui32MPUFaultCount = 0;
    ...
    {
        GrStringDraw(&g_sContext, " OK", -1, 210, 135, 0);
    }
    else
    {
        bFail = 1;
        GrStringDraw(&g_sContext, "NOK", -1, 210, 135, 0);
    }
