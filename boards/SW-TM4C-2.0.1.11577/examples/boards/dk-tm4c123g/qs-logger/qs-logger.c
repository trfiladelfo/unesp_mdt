//*****************************************************************************
//
// qs-logger.c - Data logger Quickstart application for DK-TM4C123G
//
...
//! This can be found in /ti/TivaWare-for-C-Series/windows_drivers
//! assuming you installed the software in the default folder.
//!
//! A companion Windows application, logger, can be found in the
//! /ti/TivaWare-for-C-Series/tools/bin directory.  When the data logger's
...
WidgetActivated(tWidget *psWidget, tSlideMenuItem *psMenuItem, bool bActivated)
{
            ...
            (psWidget == &g_sMagContainerCanvas.sBase))
    {
        ...
        if(bActivated)
        {
            ...
            sLocalState.ui16SelectedMask = 0xffff;
