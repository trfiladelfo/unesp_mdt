...
SMBusMasterIntEnable(tSMBus *psSMBus)
{
    ...
    switch(psSMBus->ui32I2CBase)
    {
        ...
        case I2C2_BASE:
        {
            ...
            {
                MAP_IntEnable(INT_I2C2_BLIZZARD);
            }
            else if(CLASS_IS_SNOWFLAKE)
            {
                MAP_IntEnable(INT_I2C2_SNOWFLAKE);
            }
            break;
        }
        ...
        case I2C3_BASE:
        {
            if(CLASS_IS_BLIZZARD)
            {
                MAP_IntEnable(INT_I2C3_BLIZZARD);
            }
            else if(CLASS_IS_SNOWFLAKE)
            {
                MAP_IntEnable(INT_I2C3_SNOWFLAKE);
            }
            break;
        }
        ...
        case I2C4_BASE:
        {
            if(CLASS_IS_BLIZZARD)
            {
                MAP_IntEnable(INT_I2C4_BLIZZARD);
            }
            else if(CLASS_IS_SNOWFLAKE)
            {
                MAP_IntEnable(INT_I2C4_SNOWFLAKE);
            }
            break;
        }
        ...
        case I2C5_BASE:
        {
            if(CLASS_IS_BLIZZARD)
            {
                MAP_IntEnable(INT_I2C5_BLIZZARD);
            }
            else if(CLASS_IS_SNOWFLAKE)
            {
                MAP_IntEnable(INT_I2C5_SNOWFLAKE);
            }
            break;
        }
        ...
        case I2C6_BASE:
        {
            ...
            {
                MAP_IntEnable(INT_I2C7_SNOWFLAKE);
            }
            break;
        }
        ...
        case I2C8_BASE:
        {
            if(CLASS_IS_SNOWFLAKE)
            {
                MAP_IntEnable(INT_I2C8_SNOWFLAKE);
            }
            break;
        }
        ...
        case I2C9_BASE:
        {
            if(CLASS_IS_SNOWFLAKE)
            {
                MAP_IntEnable(INT_I2C9_SNOWFLAKE);
            }
            break;
        }
    }
...
SMBusSlaveIntEnable(tSMBus *psSMBus)
{
    ...
    switch(psSMBus->ui32I2CBase)
    {
        ...
        case I2C6_BASE:
        {
            if(CLASS_IS_SNOWFLAKE)
            {
                MAP_IntEnable(INT_I2C6_SNOWFLAKE);
            }
            break;
        }
