...
// 
// This is part of revision 2.0.1.11577 of the Tiva USB Library.
//
//*****************************************************************************
...
//*****************************************************************************
//
// Enable or disable support for LPM for devices in the USB library.
//
// \param ui32Index is the index of the USB controller to access.
// \param ui32Feature is USBLIB_FEATURE_LPM
// \param pvFeature is a pointer to an 32-bit value that holds the settings.
//
...
// USB library is to not support LPM transactions.
//
// The following are the settings for the \b USBLIB_FEATURE_LPM feature
// request.
//
// - USBLIB_FEATURE_LPM_EN is used to enable LPM support in host or device
//  mode.
// - USBLIB_FEATURE_LPM_DIS(default) is used to disable LPM support in host or
// device mode.
//
// \return Returns \b true if the setting was accepted and \b false if this
...
//*****************************************************************************
//
// Method to inform the USB library of the current processor speed in Hz.
//
// \param ui32Index is the index of the USB controller to access.
// \param ui32Feature is USBLIB_FEATURE_CPUCLK
// \param pvFeature is a pointer to an 32-bit value that holds the processor
//  speed in Hz.
//
...
// counter is not yet running.  The \e pvFeature is a pointer to an 32-bit
// value that holds the processor speed in Hz.
//
// \return Returns \b true if the setting was accepted and \b false if this
// setting is not supported.
//
...
//*****************************************************************************
//
// Method to inform the USB library of the PLL speed in Hz.
//
// \param ui32Index is the index of the USB controller to access.
// \param ui32Feature is USBLIB_FEATURE_USBPLL
// \param pvFeature is a pointer to an 32-bit value that holds the USB PLL
//  speed in Hz.
//
// This feature setting allows an application to inform the USB library of the
// current USB PLL rate in case the USB library needs this information for
// internal configuration.  If this feature is not set, then default rate
// for the USB PLL is 480MHz.  The \e pvFeature is a pointer to an 32-bit value
// that holds the USB PLL speed in Hz.  If the application needs to use an
// external USB clock the PLL value should be set to zero.  This is used when
// connecting to an external USB phy which is providing the 60-MHz clock.
//
// \return Returns \b true if the setting was accepted and \b false if this
// setting is not supported.
//
...
//
// \param ui32Index is the index of the USB controller to access.
// \param ui32Feature is USBLIB_FEATURE_USBULPI
// \param pvFeature is a pointer to an 32-bit value that holds the USB ULPI
// settings
//
...
#define USBLIB_FEATURE_ULPI_LS  0x00000020
