...
//*****************************************************************************
//
// The Tiva-specific binary image suffix used by the DFU driver to
...
PrintWelcome(void)
{
    ...
    QUIETPRINT("Copyright (c) 2008-2013 Texas Instruments Incorporated.  All rights reserved.\n\n");
}
...
// it for the DFU suffix and Tiva prefix.
//
...
//*****************************************************************************
//
// Dump the contents of the Tiva-specfic DFU file prefix.
//
//*****************************************************************************
void
